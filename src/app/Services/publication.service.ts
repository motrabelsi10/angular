...
export class PublicationService {
  ...
  getPublication(idPublication : any){
    return this.httpClient.get(`${this.API_URL}/retrieve-publication/${idPublication}`)
  }
  editPublication(publication : any){
    return this.httpClient.put(`${this.API_URL}/modify-publication`, publication)
  }
  deletePublication(idPublication : any){
    return  this.httpClient.delete(`${this.API_URL}/remove-publication/${idPublication}`)
  }

  retrievePublicationByNamePublication(namePublication : any){
    return  this.httpClient.get(`${this.API_URL}/retrieve-publication-by-name/${namePublication}`)
